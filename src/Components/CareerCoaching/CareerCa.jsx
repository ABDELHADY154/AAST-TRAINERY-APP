...
export default class CareerCa extends Component {
  state = {
    isBooked: false,
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        />
        <Text style={styles.title}>Make the Right Career Move</Text>
        <ScrollView>
          <Image
            source={img}
            style={{
          ...
          >
            ...
            your dedicated career coach will help you answer the question, “what
            is the best career for me?” through identifying your personality,
            skills, interests, and career values, Accurately identify how ready
            you are for your targeted career and how satisfied you would be in
            this career, Put together a tailored and detailed career plan for
